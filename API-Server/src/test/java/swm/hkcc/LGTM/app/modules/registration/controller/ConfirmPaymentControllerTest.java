...
public class ConfirmPaymentControllerTest {
    ...
    @Test
    @DisplayName("confirmPayment_동작_테스트")
    void confirmPayment_동작_테스트() throws Exception {
        ...
        // when
        // then
        ResultActions actions = mockMvc.perform(post("/v1/mission/{missionId}/confirm/{juniorId}", getMockMission().getMissionId(), getMockJunior().getMemberId())
    ...
    @Test
    @DisplayName("confirmPayment_시니어_아닌_경우")
    void confirmPayment_예외_NOT_SENIOR_MEMBER() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_SENIOR_MEMBER;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotSeniorMember());
        ...
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-senior-member"// 문서의 고유 id
        ));
    }

    @Test
    @DisplayName("confirmPayment_미션_존재하지_않는_경우")
    void confirmPayment_예외_NOT_EXIST_MISSION() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_EXIST_MISSION;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotExistMission());
        ...
        // document
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-exist-mission"// 문서의 고유 id
        ));
    }

    @Test
    @DisplayName("confirmPayment_미션_내_미션이_아닌_경우")
    void confirmPayment_예외_NOT_MY_MISSION() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_MY_MISSION;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotMyMission());
        ...
        // document
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-my-mission"// 문서의 고유 id
        ));
    }

    @Test
    @DisplayName("confirmPayment_회원_존재하지_않는_경우")
    void confirmPayment_예외_NOT_EXIST_MEMBER() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_EXIST_MEMBER;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotExistMember());
        ...
        // document
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-exist-member"// 문서의 고유 id
        ));
    }

    @Test
    @DisplayName("confirmPayment_주니어_아닌_경우")
    void confirmPayment_예외_NOT_JUNIOR_MEMBER() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_JUNIOR_MEMBER;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotJuniorMember());
        ...
        // document
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-junior-member"// 문서의 고유 id
        ));
    }

    @Test
    @DisplayName("confirmPayment_미션_등록되지_않은_경우")
    void confirmPayment_예외_NOT_REGISTERED_MISSION() throws Exception {
        // given
        ResponseCode expectedResponseCode = ResponseCode.NOT_REGISTERED_MISSION;

        given(memberRepository.findOneByGithubId(Mockito.anyString())).willReturn(java.util.Optional.ofNullable(getMockSenior()));
        given(registrationService.confirmPayment(any(), any(), any())).willThrow(new NotRegisteredMission());
        ...
        // document
        actions.andDo(MockMvcRestDocumentationWrapper.document(
                "post-senior-confirm-payment-fail-not-registered-mission"// 문서의 고유 id
        ));
    }
